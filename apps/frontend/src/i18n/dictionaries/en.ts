export const enMessages = {
  common: {
    ...
    notFoundAction: "Go back home",
    errorTitle: "Something went wrong",
    errorDescription: "An unexpected error occurred. Please try again.",
    errorAction: "Try again",
    processNotFoundTitle: "Process not found",
    processNotFoundDescription: "The process you are looking for does not exist or has been removed.",
    processNotFoundAction: "Back to communications",
  },
  auth: {
