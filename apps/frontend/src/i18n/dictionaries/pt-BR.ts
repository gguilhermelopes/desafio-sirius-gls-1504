export const ptBRMessages = {
  common: {
    ...
    notFoundDescription: "A página que você está procurando não existe ou foi removida.",
    notFoundAction: "Voltar ao início",
    errorTitle: "Algo deu errado",
    errorDescription: "Ocorreu um erro inesperado. Tente novamente.",
    errorAction: "Tentar novamente",
    processNotFoundTitle: "Processo não encontrado",
    processNotFoundDescription: "O processo que você está procurando não existe ou foi removido.",
    processNotFoundAction: "Voltar para comunicações",
  },
  auth: {
